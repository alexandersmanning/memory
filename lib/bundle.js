...
/***/ function(module, exports, __webpack_require__) {
	...
	document.addEventListener("DOMContentLoaded", function () {
		var game = newGame([new _player2.default("green"), new _computer_player2.default("yellow")]);
	
		document.getElementById("1p").addEventListener("click", function (e) {
			game = newGame([new _player2.default("green")]);
		});
	
		document.getElementById("1pv1p").addEventListener("click", function (e) {
			game = newGame([new _player2.default("green"), new _player2.default("yellow")]);
		});
	
		document.getElementById("1pv1c").addEventListener("click", function (e) {
			game = newGame([new _player2.default("green"), new _computer_player2.default("yellow")]);
		});
	});
	...
	var newGame = function newGame(players) {
		...
		var view = new _view2.default(game, board);
	};
